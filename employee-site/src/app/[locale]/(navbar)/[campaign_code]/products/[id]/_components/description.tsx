  ...
  useEffect(() => {
    const tabs = [
          ...
          <div>
            <div className="w-full">
              ...
              <div className="grid grid-cols-4 md:grid-cols-5 gap-4 mt-4 mb-10">
                <div className="col-span-3 md:col-span-1 font-normal text-sm leading-[22px]">
                  {t('productDetails.category')}
                </div>
                <div className="col-span-1 md:col-span-4 font-normal text-sm leading-[22px] break-words">
                  {product?.categories.map((c) => c.name).join(', ')}
                </div>
                <div className="col-span-3 md:col-span-1 font-normal text-sm leading-[22px]">
                  {t('productDetails.brand')}
                </div>
                <div className="col-span-1 md:col-span-4 font-normal text-sm break-words leading-[22px]">
                  {product?.brand.name}
                </div>
                <div className="col-span-3 md:col-span-1 font-normal text-sm leading-[22px]">
              ...
              <div className="w-full gap-4 mt-4 text-sm	font-normal leading-[22px] whitespace-pre-wrap">
      ...
      },
      {
        ...
        content: (
          <div className="whitespace-pre-wrap text-sm	font-normal leading-[22px]">
          ...
          <div className="bg-white shadow-xl rounded-lg">
            {tabs && (
              <Tabs
                ...
                variant="underlined"
                classNames={{
                  tab: 'me-6 py-7 data-[selected=true]:font-bold text-sm leading-[22px]',
